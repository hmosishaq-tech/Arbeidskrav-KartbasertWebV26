...
var LercDecoder = class extends BaseDecoder {
  decodeBlock(buffer) {
    ...
    const lercResult = import_lerc.default.decode(buffer, { returnPixelInterleavedDims: this.parameters.planarConfiguration === 1 });
...
//# sourceMappingURL=lerc-UTDRCV2O.js.map
