...
function get2(image, src, imageAttributes, imageState, color, pattern) {
...
function drawTextOnPath(flatCoordinates, offset, end, stride, text, startM, maxAngle, scale3, measureAndCacheTextWidth2, font, cache, rotation, keepUpright = true) {
